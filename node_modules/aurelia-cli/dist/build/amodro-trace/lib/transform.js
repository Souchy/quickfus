 ...
 */
/*global define */
define(['esprima', './parse', './lang'], function (esprima, parse, lang) {
    'use strict';
    var transform, jsExtRegExp = /\.js$/g, baseIndentRegExp = /^([ \t]+)/, indentRegExp = /\{[\r\n]+([ \t]+)/, keyRegExp = /^[_A-Za-z]([A-Za-z\d_]*)$/, bulkIndentRegExps = {
        '\n': /\n/g,
        '\r\n': /\r\n/g
    };
    ...
    transform = {
        toTransport: function (namespace, moduleName, path, contents, onFound, options) {
            options = options || {};
            var astRoot, contentLines, modLine, foundAnon, scanCount = 0, scanReset = false, defineInfos = [], applySourceUrl = function (contents) {
            ...
            parse.traverse(astRoot, function (node) {
                ...
                if (namespaceExists || parse.isDefineNodeWithArgs(node)) {
                    ...
                    if (range.needsId) {
                        ...
                        // need to pass foundId to onFound callback
                        defineInfos.push(range);
                    }
                }
            });
            ...
            modLine = function (loc, contentInsertion) {
                ...
                lineIndex = loc.start.line - 1, line = contentLines[lineIndex];
        ...
        objectToString: function (obj, options, totalIndent) {
            var startBrace, endBrace, nextIndent, first = true, value = '', lineReturn = options.lineReturn, indent = options.indent, outDentRegExp = options.outDentRegExp, quote = options.quote || '"';
